...
public class MainActivitydst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maindst);
    ...
    public void loadDataList(Cursor cursor, ArrayList<HashMap<String, String>> dataList) {
        if (cursor != null) {
            ...
            while (cursor.isAfterLast() == false) {
                ...
                mapToday.put("code", cursor.getString(2).toString());
                mapToday.put("room", cursor.getString(3).toString());
                mapToday.put("date", cursor.getString(4).toString());
                mapToday.put("status", cursor.getString(5).toString());
    ...
    public void loadListView(NoScrollListView listView, final ArrayList<HashMap<String, String>> dataList) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(MainActivitydst.this, AddModifyTask.class);
