...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "CREATE TABLE " + TABLE_NAME + "(id INTEGER PRIMARY KEY, task TEXT,code TEXT, room TEXT, task_at DATETIME, status INTEGER)"
        );
    }
    ...
    public boolean insertTask(String task,String code,String room, String task_at) {
        Date date;
    ...
    public boolean updateTask(String id, String task,String code,String room, String task_at) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
